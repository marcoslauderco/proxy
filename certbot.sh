...
docker run -it --rm --name certbot -p 80:80 -v "/home/sistemas/proxy/certs:/etc/letsencrypt" certbot/certbot certonly --standalone --force-renew -d marcoslauder.com.br,casamento.marcoslauder.com.br,chatbotcasamento.marcoslauder.com.br  
