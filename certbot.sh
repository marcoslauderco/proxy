...
docker run -it --rm --name certbot -p 80:80 -v "/home/sistemas/proxy/certs:/etc/letsencrypt" -v "/home/sistemas/proxy/html:/var/www/html" certbot/certbot certonly --force-renew -d marcoslauder.com.br,casamento.marcoslauder.com.br,chatbotcasamento.marcoslauder.com.br  
